        ...
        <Card className="lg:col-span-1 h-fit shadow-2xl border-0 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-[2rem] overflow-hidden">
          <CardHeader className="pt-8 px-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-xl font-headline font-bold">Add New Tier</CardTitle>
              ...
              <Table>
                <TableHeader className="bg-muted/30">
                  <TableRow className="border-border/50 hover:bg-transparent">
                    ...
                    <TableHead className="text-right w-[100px] px-6 h-14 text-muted-foreground">Action</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {loading ? (
                      ...
                      <TableCell colSpan={5} className="h-64 text-center px-6">
                        <div className="flex flex-col items-center justify-center text-muted-foreground gap-4 opacity-30">
                          ...
                          <div className="space-y-1">
                            <p className="text-sm font-black uppercase tracking-widest">No tiers registered</p>
                            <p className="text-xs font-medium">Add your first wholesale price level using the form.</p>
                          </div>
                        </div>
                      </TableCell>
                    </TableRow>
